...
mysqli_query($conn, "SET SESSION collation_connection = 'utf8_general_ci'");
 ...
 $sql = 'SELECT `order_details`.`book_order_id`,  `user_name`,`user_address`,`user_mobile`,`payment_method`,`status`,`total_price`,`created_at`, `order_details`.`book_name` ,`order_details`.`book_quantity` ,`order_details`.`book_price` FROM `order_details` INNER JOIN `book_order` ON order_details.book_order_id= book_order.id WHERE status="S" ';
...
<div class="header">
		...
		<h2 style="color: #23787C">Confirm Order Data Sheet</h2>
	</div>
...
<ul>
	...
	<li>
	    <a href="http://coxtunes.com/client_mobile_app_project/onlineorder/captaincox/web/confirm_order/confirm.php" class="active"  >কনফার্ম অর্ডার সমূহ </a>
	    </li>
	    
	<li>
	    <a href="http://coxtunes.com/client_mobile_app_project/onlineorder/captaincox/web/pending_order/pending.php" >পেনডিং অর্ডার সমুূহ </a>
	   </li>
