...
mysqli_query($conn, "SET SESSION collation_connection = 'utf8_general_ci'");
 ...
 $sql = 'SELECT `order_details`.`book_order_id`,  `user_name`,`user_address`,`user_mobile`,`payment_method`,`status`,`total_price`,`created_at`, `order_details`.`book_name` ,`order_details`.`book_quantity` ,`order_details`.`book_price` FROM `order_details` INNER JOIN `book_order` ON order_details.book_order_id= book_order.id WHERE status="C" ';
...
<div class="header">
		...
		<h2 style="color: #23787C">Cancel Order Data Sheet</h2>
	</div>
...
<ul>
	...
	<li>
	    <a href="http://coxtunes.com/client_mobile_app_project/onlineorder/captaincox/web/cancel_order/cancel.php" class="active"  >বাতিল অর্ডার সমূহ </a>
	</li>
